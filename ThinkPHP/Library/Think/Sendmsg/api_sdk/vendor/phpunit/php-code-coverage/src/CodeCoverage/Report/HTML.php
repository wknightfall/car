...
class PHP_CodeCoverage_Report_HTML
{
    ...
    private function copyFiles($target)
    {
        ...
        copy($this->templatePath . '__JS__/bootstrap.min.js', $dir . 'bootstrap.min.js');
        copy($this->templatePath . '__JS__/d3.min.js', $dir . 'd3.min.js');
        copy($this->templatePath . '__JS__/holder.min.js', $dir . 'holder.min.js');
        copy($this->templatePath . '__JS__/html5shiv.min.js', $dir . 'html5shiv.min.js');
        copy($this->templatePath . '__JS__/jquery.min.js', $dir . 'jquery.min.js');
        copy($this->templatePath . '__JS__/nv.d3.min.js', $dir . 'nv.d3.min.js');
        copy($this->templatePath . '__JS__/respond.min.js', $dir . 'respond.min.js');
    }
