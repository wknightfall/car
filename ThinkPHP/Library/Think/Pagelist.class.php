...
class Pagelist{
    ...
    private $config  = array(
        ...
        'prev'   => '<img src="/Public/Home/images/pageLeft.png">',		//上一页
        'next'   => '<img src="/Public/Home/images/pageRight.png">',		//下一页
        'first'  => '<<',		//首页
        //'last'   => '...%TOTAL_PAGE%',
    	'last'   => '>>',		//末页
    ...
    public function show() {
        ...
        //$the_first = '';
   		//$the_first = '<li class="first-child"><a href="' . $this->url(1) . '">' . $this->config['first'] . '</a></li>';
        ...
        //$the_end = '<li class="last-child"><a href="' . $this->url($this->totalPages) . '">' . $this->config['last'] . '</a></li>';
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<div class=\"page mt10\"><div class=\"pagination\"><ul>{$page_str}</ul></div></div>";
    }
}
