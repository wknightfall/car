...
function pointList($point){
	...
	if($point >0 & $point<=2){
		...
		return '<em class="ev_rad"></em><em></em><em></em><em></em><em></em>';
		
	}elseif($point >2 & $point<=4){
		
		return '<em class="ev_rad"></em><em class="ev_rad"></em><em></em><em></em><em></em>';
		
	}elseif($point >4 & $point<=6){
		
		return '<em class="ev_green"></em><em class="ev_green"></em><em class="ev_green"></em><em></em><em></em>';
		
	}elseif($point >6 & $point<=8){
		
		return '<em class="ev_green"></em><em class="ev_green"></em><em class="ev_green"></em><em class="ev_green"></em><em></em>';
		
	}elseif($point >8 & $point<=10){
		
		return '<em class="ev_green"></em><em class="ev_green"></em><em class="ev_green"></em><em class="ev_green"></em><em class="ev_green"></em>';
...
function picture($id){
	...
	if(empty($picture['path'])){
		...
		return '/Public/Home/img/tu1.jpg';
...
//文件
function file_url($file_id){
    $vo = M('file')->find($file_id);
    return '/Uploads/Download/'.$vo['savepath'].$vo['savename'];
}